#
#  Be sure to run `pod spec lint EspressifTouchSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.1"
  spec.summary      = "EspressifTouch SDK v1.0.1"
  ...
  spec.author             = { "fanbaoying" => "fanbaoying@espressif.com" }
  # Or just: spec.author    = "fanbaoying"
  # spec.authors            = { "fanbaoying" => "fanbaoying@espressif.com" }
  # spec.social_media_url   = "https://twitter.com/fanbaoying"
  ...
  spec.source       = { :git => "https://github.com/EspressifApps/EspressifTouchSDK.git", :tag => "#{spec.version}" }
